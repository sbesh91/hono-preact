...
| `server` | `() => Promise<unknown>` | optional, leaves only | The sibling `.server.ts` module behind a dynamic import. Carries `loader`, `serverActions`, `serverGuards`, `actionGuards`. |
