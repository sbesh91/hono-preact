...
| `src/pages/<name>.tsx` | View component. Default-exports the page; uses `definePage` when it has loader/cache/guard bindings. |
| `src/pages/<name>.server.ts` | Server-only sibling. Holds the default-exported loader plus optional `loader`, `cache`, `serverActions`, `serverGuards`, `actionGuards` named exports. |
