...
>
  {(t) => (
    ...
    not-data-expanded:[--toast-scale:calc(1-0.05*min(var(--toasts-before,0),2))]
    not-data-expanded:[opacity:calc(1-max(0,var(--toasts-before,0)-2))]
    data-expanded:[--toast-scale:1] data-expanded:opacity-100
