...
If you've configured your own `cssMinify` or `css.lightningcss` in `vite.config.ts`, your settings win outright over the framework's defaults, including the Baseline browser targets.
