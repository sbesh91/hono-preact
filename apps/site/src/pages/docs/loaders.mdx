...
Pages need data. Loaders run on the server — as a direct function call during SSR, and as an automatic RPC call during client-side navigation — so you never write the branch manually.
