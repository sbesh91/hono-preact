...
See [Middleware](/docs/middleware) for the `use` binding, and [Project Structure](/docs/structure) for the full `definePage` bindings list (including `Wrapper`).

- [Server Loaders](/docs/loaders): where `.View()` comes from.
- [Streaming](/docs/streaming): fallback behavior for streaming loaders.
