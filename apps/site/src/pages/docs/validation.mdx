...
| Option         | Type               | Description                                                                                                                                                 |
| -------------- | ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `searchSchema` | `StandardSchemaV1` | Validates and coerces `ctx.location.searchParams`. Failure throws 400 to the error boundary (a `LoaderValidationError` carrying issues on the client path). |
| `paramsSchema` | `StandardSchemaV1` | Validates and coerces `ctx.location.pathParams`. Failure throws 404 to the error boundary (a `LoaderValidationError` carrying issues on the client path).   |
