...
export function Router({mutable = true, ...props}) {
...
cloneElement, createContext, h, toChildArray, import { undefined } from 'preact-iso/router';
useContext, useLayoutEffect, useMemo, useReducer, useRef, 